...
const MouseEvents = () => {
  ...
  return (
    <div className=''  >
        ...
        <div className='w-1/2 h-24 mx-auto bg-red-300' onMouseOver={()=> console.log('mouse over event triggered')} 
        ...
        <div className='w-1/2 h-24 bg-blue-300 mx-auto my-4'>
        ...
        <div className='w-1/2 bg-red-200 h-24 mx-auto' >
